...
<textarea name="Your_Message" id="Your_Message" onblur="clearText(this)" onfocus="clearText(this)" value="Message" rows="0" cols="0" class="required" style="width:304px;">Message </textarea>

</div>



<div id="cln_10"><div id="blank_10"><div class="g-recaptcha" style="margin-top: 15px;" data-sitekey="6Le0SxETAAAAAPeWR2qoTm327eBwHai4D3BAwoAW"></div></div></div>

<div id="cln" style="width: 304px; margin-top: 90px;">

<input type="submit" class="submit_btn float_l" name="contact" value="SEND" style="margin-right: 0px;">
